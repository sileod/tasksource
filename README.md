...
See supported 419 tasks in [tasks.md](https://github.com/sileod/tasksource/blob/main/tasks.md) (+200 MultipleChoice tasks, +100 Classification tasks). Feel free to request or propose a new task.
